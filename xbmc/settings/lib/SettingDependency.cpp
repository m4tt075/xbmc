...
CSettingDependencyCondition::CSettingDependencyCondition(
    ...
    bool negated /* = false */,
    CSettingsManager* settingsManager /* = nullptr */)
  : CSettingDependencyCondition(settingsManager, setting, setting, value, SettingDependencyTarget::Setting, op, negated)
{
}
...
CSettingDependencyCondition::CSettingDependencyCondition(
    ...
    bool negated /* = false */,
    CSettingsManager* settingsManager /* = nullptr */)
  : CSettingDependencyCondition(settingsManager, strProperty, setting, value, SettingDependencyTarget::Property, SettingDependencyOperator::Equals, negated)
{
}
